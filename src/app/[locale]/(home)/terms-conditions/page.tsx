    ...
    <div className="min-h-screen bg-background py-8">
      <div className="container mx-auto max-w-4xl px-4">
        <div className="mb-8 text-center">
          ...
          <h1 className="mb-2 text-4xl font-bold text-foreground">{t("pageTitle")}</h1>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="leading-relaxed text-card-foreground">{mainSection.content}</p>
          </CardContent>
        </Card>
        ...
        <div className="space-y-6">
          {otherSections.map((section, index) => {
            const IconComponent =
              sectionIcons[section.title as keyof typeof sectionIcons] || FileText;
            const isWarning = section.title === "Prohibited Activities";
            const isImportant =
              section.title === "Governing Law" || section.title === "Modifications to the Terms";
            ...
            return (
              ...
              >
                ...
                <CardContent>
                  <p className="leading-relaxed text-card-foreground">{section.content}</p>
