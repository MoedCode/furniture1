...
export const metadata : Metadata = {
  title: "أسعار نقل أثاث مكتبي مع شركة السلام – الجودة التي تستحقها",
  description:
    "اكتشف أسعار نقل الأثاث المكتبي مع شركة السلام، حيث نقدم خدمات تغليف ونقل وتركيب بأعلى جودة وبأسعار تنافسية في السعودية.",
  keywords: [
    "نقل أثاث مكتبي",
    "أسعار نقل أثاث",
    "شركة السلام لنقل الأثاث",
    "تغليف الأثاث المكتبي",
    "نقل وتركيب الأثاث",
    "نقل عفش مكتبي السعودية",
    "خدمات نقل أثاث بجدة والرياض",
    "شركة نقل عفش احترافية",
    "أفضل شركات نقل الأثاث",
  ],
  openGraph: {
    title: "أسعار نقل أثاث مكتبي مع شركة السلام – الجودة التي تستحقها",
    description:
      "شركة السلام تقدم أفضل خدمات نقل الأثاث المكتبي في السعودية مع تغليف احترافي وأسعار تنافسية.",
...
export default async function Page({
  ...
  try {
    ...
    console.log(
      `[FETCH] ${getApiUrl("/blog/data")} (${response.status}): `,
      data,
    );
        ...
        <Card className="overflow-hidden shadow-lg border-0 bg-gradient-to-b from-background to-muted/20">
          ...
          <div className="relative aspect-[16/9] w-full overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-20 p-6 md:p-8">
              <Badge
                variant="secondary"
                className="mb-4 bg-white/90 text-black"
              >
